...
The languages I know are CSS, HTTP, Java, Javascript, PHP, Python, and SQL.  
I prefer working with back-end issues, but I would be willing
to work in Python's Tkinter library.
I prefer to avoid web development issues.
I would like to practice working with a Python API or a Python CRUD system.  
I especially like working with database or information management systems.  
I am uncomfortable with CLI tools, but I am willing to work with config-driven 
codebases.
