...
I'm familiar with Python.  I have used many of its most popular libraries,
including Django, Numpy, and Pandas.  I have experience working with APIs. 
I'm most comfortable with backend work, like configuration.  I want to avoid
anything that requires me to use a language other than Python.
